...
import product2Image from "../../assets/images/products/table/product-2.jpg";
const Cart = () => {
    return (
        <Fragment>
			<Header />
            <main className="main">
        	<div className="page-header text-center" style={{backgroundImage: `url(${pageHeaderImage})`}}>
										...
										<tr>
											<td className="product-col">
												<div className="product">
													<figure className="product-media">
														<a href="#!">
															<img src={product2Image} alt="Product " />
														</a>
													</figure>
